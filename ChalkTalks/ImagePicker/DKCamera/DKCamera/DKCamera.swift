...
//            }
            ...
            captureButton.setImage(DKDefaultCameraResource().cameraCaptureImage(), for: .normal)
...
//            captureButton.layer.masksToBounds = true
    ...
    @objc public func dismissCamera() {
        self.didCancel?()
    }
    ...
    @objc public func switchFlashMode() {
...
open class DKDefaultCameraResource: DKCameraResource {
    ...
    public func cameraCaptureImage() -> UIImage {
        return imageForResource("camera_capture")
    }
}
