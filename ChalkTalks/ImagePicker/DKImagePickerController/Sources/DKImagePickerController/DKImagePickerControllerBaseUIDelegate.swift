...
public protocol DKImagePickerControllerUIDelegate {
    ...
    */
    ...
    func videoCaptureRecordingView() -> DKVideoCaptureRecordingView
}
...
open class DKImagePickerControllerBaseUIDelegate: NSObject, DKImagePickerControllerUIDelegate {
    ...
    open func videoCaptureRecordingView() -> DKVideoCaptureRecordingView {
        return DKVideoCaptureRecordingView()
    }
    
    // MARK: - Audio Reccord
    
    open func createNew() -> DKImagePickerControllerBaseUIDelegate {
        return DKImagePickerControllerBaseUIDelegate()
    }
}
