...
//        [self setOperationType:YBIBTopViewOperationTypeBack];
    }
    return self;
}
...
- (void)layoutSubviews {
    ...
    self.pageLabel.frame = CGRectMake((width-100)/2.0f, 0, 100, height);
...
- (void)setOperationType:(YBIBTopViewOperationType)operationType {
    ...
    switch (operationType) {
        ...
        case YBIBTopViewOperationTypeMore:
            ...
            break;
        case YBIBTopViewOperationTypeBack:
            image = ImageNamed(@"app_navback_btn");
            break;
    }
...
- (UIButton *)operationButton {
    if (!_operationButton) {
        ...
        [_operationButton setTintColor:[UIColor whiteColor]];
    }
