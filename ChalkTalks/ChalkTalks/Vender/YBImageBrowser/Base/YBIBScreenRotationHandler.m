...
- (void)deviceOrientationDidChangeNotification:(NSNotification *)note {
    ...
    // Align.
    [_browser.collectionView scrollToPage:_browser.currentPage showAnimation:NO];
    ...
    [self->_browser.collectionView scrollToPage:currentPage showAnimation:NO];
...
- (void)applicationDidChangedStatusBarOrientationNotification:(NSNotification *)noti {
    ...
    // Reset to prevent the page number change after transforming.
    [_browser.collectionView scrollToPage:_recordPage showAnimation:NO];
