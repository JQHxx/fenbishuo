...
- (void)collectionViewScrollToPage:(NSInteger)page {
    [self.collectionView scrollToPage:page showAnimation:self.showAnimation];
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    if ([self.delegate respondsToSelector:@selector(yb_imageBrowserWillBeginDragging:)]) {
        [self.delegate yb_imageBrowserWillBeginDragging:self];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if (scrollToScrollStop) {
        if ([self.delegate respondsToSelector:@selector(yb_imageBrowserDidEndScroll:)]) {
            [self.delegate yb_imageBrowserDidEndScroll:self];
        }
    }
}
