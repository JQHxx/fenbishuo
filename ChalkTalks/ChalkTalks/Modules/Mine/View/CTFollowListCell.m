...
@interface CTFollowListCell ()
@property (nonatomic, strong) UIImageView *headImageView;
@property (nonatomic, strong) UILabel *nameLabel;
@property (nonatomic, strong) UILabel *headLineLabel;
@property (nonatomic, strong) UIButton *careBtn;

@property (nonatomic, strong) CTFFollowUserModel *model;
@end

@implementation CTFollowListCell
...
- (void)fillContentWithData:(CTFFollowUserModel *)model {
...
- (void)careBtnAction:(UIButton *)btn {
    ...
    if ([btn.titleLabel.text isEqualToString:@"互相关注"] || [btn.titleLabel.text isEqualToString:@"已关注"]) {
        ...
        if (self.deleteFollowBlock) {
            self.deleteFollowBlock(self.model.followId, self.indexRow);
        }
    } else {
        // TO DO : 关注
        if (self.addFollowBlock) {
            self.addFollowBlock(self.model.followId, self.indexRow);
        }
    }
}
