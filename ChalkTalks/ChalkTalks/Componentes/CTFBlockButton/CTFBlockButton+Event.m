...
#import "CTFBlockButton+Event.h"
#import <objc/runtime.h>

//默认延迟时间间隔
static const NSTimeInterval kDefaultDelayDuration = .4f;

@interface CTFBlockButton ()
//bool YES 忽略点击事件   NO 允许点击事件
@property (nonatomic, assign) BOOL isIgnoreEvent;
@end

@implementation CTFBlockButton (Event)
...
{
    self.eventTimeInterval = self.eventTimeInterval == 0 ? kDefaultDelayDuration : self.eventTimeInterval;
